...
13. Открыть панель → сетка обликов 4×2, все восемь превью анимированы,
...
22. Включить тумблер «Прятать остров, когда сессий нет» при нуле сессий → остров исчезает; запустить сессию → остров возвращается сам, без клика по меню.
23. Клик по строке сессии прыгает в терминал и закрывает меню.
24. Переключение вида в обе стороны: плавающий кот возвращается на сохранённое место, остров исчезает без остатка; панель плавающего режима после распила выглядит и ведёт себя как раньше.
25. На машине, где встроенный экран не главный и стоит не в начале координат в настройках «Расположение» дисплеев (Системные настройки → Дисплеи → Расположение), остров всё равно на месте — не сдвинут и не обрезан. Весь расчёт предполагает, что вспомогательные области выреза приходят в тех же глобальных координатах, что и `NSScreen.frame`; на целевой машине встроенный экран стоит в начале координат, поэтому две интерпретации неразличимы и ни один тест их не разводит.
26. Выбрать «Остров» на экране без выреза (внешний монитор, закрытая крышка) → под переключателем вида появляется подсказка «На этом экране нет выреза — остров не появится», а не молчаливое исчезновение маскота.
