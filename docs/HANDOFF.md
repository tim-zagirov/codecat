...
Плавность анимаций, перетаскивание котика и сохранение позиции между запусками, отклик переключателей в панели деталей, сводка «пока тебя не было» после разблокировки экрана, весь переход к сессии (пункты 9–12) и весь переключатель обликов (пункты 13–16). Спрайтовые облики проверены только рендером в PNG — все 45 сочетаний «облик × состояние» отрисованы и просмотрены, но в живом приложении их никто не видел. И весь остров целиком — второй режим отображения, в вырезе экрана, в живом приложении никто не видел: пункты 17–24.
