...
- [x] **Step 1: Написать Info.plist и Makefile**
...
- [x] **Step 5: Финальный прогон тестов и ручной чек-лист**
